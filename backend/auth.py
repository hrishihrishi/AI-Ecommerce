...
This module provides utility functions for verifying and hashing
passwords, creating JWT access tokens, and verifying tokens.
"""
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None):
    ...
    `expires_delta` can be used to override the default token lifetime.
...
def verify_token(token: str) -> dict:
    ...
    Raises an HTTPException for expired or invalid tokens.
    """
    try:
