...
const Home: React.FC = () => {
  ...
  const categoryData: CategoryData[] = [
    ...
    },
    {
      ...
      link: "/products?category=Battery",
    },
    {
      name: "Display & Screens",
      icon: "📱",
      bg: "from-purple-400 to-pink-500",
      link: "/products?category=Display & Screens",
    },
    {
      name: "Camera",
      icon: "📷",
    ...
    },
    {
      ...
      link: "/products?category=Charging Port",
    },
    {
      name: "Laptop Parts",
      icon: "💻",
  ...
  const reviews: Review[] = [
    {
      name: "Rahul M.",
      rating: 5,
      text: "Excellent quality display! Works perfectly on my Samsung S21. Fast delivery too.",
      initial: "R",
      color: "bg-blue-500",
    },
    {
      name: "Priya S.",
      rating: 5,
      text: "Very happy with the battery replacement. Lasts much longer now. Highly recommended!",
      initial: "P",
      color: "bg-pink-500",
    },
    {
      name: "Amit K.",
      rating: 4,
      text: "Good product, proper packaging. Delivery was quick. Will order again.",
      initial: "A",
      color: "bg-indigo-500",
    },
  ];
  ...
  const faqs: Faq[] = [
    {
      q: "Why choose Super Commerce for mobile spare parts?",
    ...
    {
      q: "Are Super Commerce mobile spare parts original or compatible?",
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50 pb-16 md:pb-0"
        ...
        <div className="container mx-auto px-4">
          <div className="flex gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {categoryData.map((cat, idx) => (
              ...
              >
                <div
                  className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${cat.bg} flex items-center justify-center text-4xl mb-2 shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 relative overflow-hidden`}
                >
                  <div className="absolute inset-0 bg-white/20 backdrop-blur-sm"></div>
                  <span className="relative z-10">{cat.icon}</span>
                </div>
                <p className="text-xs font-bold text-gray-700 w-20 leading-tight group-hover:text-orange-600 transition-colors">
                  {cat.name}
                </p>
              </Link>
            ))}
        ...
        {heroBanners.map((banner, index) => (
          ...
          >
            <div className="absolute inset-0">
              ...
              />
              <div
                className={`absolute inset-0 bg-gradient-to-br ${banner.bg} opacity-90`}
              ></div>
            ...
            {features.map((feature, idx) => (
              <div key={idx} className="relative group">
                <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg`}
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-6 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:grid md:grid-cols-3 md:overflow-visible">
            {reviews.map((review, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-80 md:w-auto bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-14 h-14 ${review.color} rounded-full flex items-center justify-center text-white font-black text-xl shadow-lg`}
                  >
                    {review.initial}
                  </div>
                  <div>
